export const Questions = [
    ...
    { id: "5", uri: require("../assets/PBS_1.png"), text: "Chcesz zdobyć umiejętności identyfikowania podatności na ataki aplikacji i systemów IoT?", name: "PBS" },
    { id: "6", uri: require("../assets/PBS_2.png"), text: "Pragniesz umieć wykryć nieuprawnioną aktywność w swoim systemie?", name: "PBS" },
